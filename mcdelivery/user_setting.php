				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Banner -->
								<form method="post" action="php_file/user_setting_SV.php">
           	    				   	<h1>회원정보</h1>
...
echo"
									...
									<div class='6u$ 12u$(xsmall)'>
                                        ...
                                        <br>
                                            ...
                                            <div class='6u$ 12u$(xsmall)'>
												<input type='password' name='password1' id='password1' value='$password' placeholder='Password' />
											</div>
                                            <div class='6u$ 12u$(xsmall)'>
												<input type='password' name='password2' id='password2' value='$password' placeholder='Repeat Password' />
											</div>
											<!-- Break -->
															<div class='3u 12u$(small)'>
                                                                <h2>성별</h2>
																<input type='radio' id='man' name='sex' value='남' ";
if($gender=='남')
	echo "checked";
echo ">
...
echo ">
															...
															<div class='12u$'>
                                                            <h2>주소</h2>     
															<textarea name='address' id='address' value='$locate' placeholder='배달될 주소를 적어주세요'></textarea>
															</div>
                                                            ";
?>
															<!-- Break -->
															<div class="12u$">
																<ul class="actions">
																	<h2><li><input type="submit" class="button special small" value="수정" size = 6/></li>
																	<li><a href="index.php"><input class="button small" value="취소" size = 6 /></a></li>
																	<li><a href="php_file/secession.php"><input class="button small" value="회원탈퇴" size = 6 /></a></li></h2>
																	</ul>
															</div>
